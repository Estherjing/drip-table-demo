...
import { CustomColumnSchema } from './custom-components';

export type SampleSubtableDataSourceKey = 'subtable' | 'subtableLevel2';

export const initSchema: DripTableSchema<CustomColumnSchema, SampleSubtableDataSourceKey> & { rowKey: string } = {
  id: 'sample-table',
  size: 'middle',
  bordered: true,
  sticky: true,
...
export const mockData: DripTableRecordTypeWithSubtable<SampleRecordType, SampleSubtableDataSourceKey>[] = [
  ...
  { id: 3, name: '商品三', pictureUrl: 'https://img14.360buyimg.com/imagetools/jfs/t1/119951/14/21336/15771/6218427eE68f8f468/e0647b9b7507755d.png', description: '商品是为了出售而生产的劳动成果，是人类社会生产力发展到一定历史阶段的产物，是用于交换的劳动产品。', status: 'onSale', price: 2099 },
